...
import static core.color.sun.data.ArHosekSkyModelData_Spectral_Dataset.*;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_SolarDataset.*;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad320;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad360;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad400;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad440;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad480;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad520;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad560;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad600;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad640;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad680;
import static core.color.sun.data.ArHosekSkyModelData_Spectral_DatasetRad.datasetRad720;
